<section id="about" class="about section" aria-labelledby="about-title">
  <div class="about-contain">
    <h2 id="about-title">{{str.about_title}}</h2>
    ...
    <p>
      <strong>{{str.about_goal_label}}</strong>
      {{str.about_goal}}
    </p>

    <div class="btn-box"><a href="/projet" class="theme-btn btn-style-one">{{str.about_cta}}</a></div>
  </div>

  <div class="illustration">
    <img src="/assets/img/peep-52.svg" alt="{{str.about_logo_alt}}" role="presentation">
  </div>
</section>